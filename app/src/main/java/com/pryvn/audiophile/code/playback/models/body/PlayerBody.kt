package com.pryvn.audiophile.code.playback.models.body
...
data class PlayerBody(
    ...
    data class ServiceIntegrityDimensions(
        val poToken: String = "Mlt6vqPMnRAc93qGSJr4d9wyzWNClpcDwVQGZ7ooTJoc6IjxwPaMoyTMXRkU5OHQQvLdQqF4v9W_U6JRCUmCPatLIOlbBqjasxsmO3PnigwoLSQ81o0MpFeX8nJA",
    )
