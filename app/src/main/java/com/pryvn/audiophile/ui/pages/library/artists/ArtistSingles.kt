...
@Composable
fun ArtistSingles(navController: NavController) {
    val artistName = rememberSaveable(key = "ArtistSingles_artistName") {
    ...
    val releases = sections.singlesAndEps
