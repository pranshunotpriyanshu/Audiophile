            ...
            content = {
                item("settings") {
                    Column(Modifier.fillMaxSize()) {
                        ...
                        // AMLL Blend Mode selector
                        RoundColumn {
                            SelectItem(
                                title = "Blend Mode",
                                items = listOf("Plus", "Multiply", "Screen", "SrcOver"),
                                value = SettingsLibrary.LyricBlendMode,
                                onValueChange = {
                                    SettingsLibrary.LyricBlendMode = it
                                }
                            )
                        }
                        ListHeader(content = "Glow intensity: Plus = glow, Multiply = darken, Screen = lighten")
